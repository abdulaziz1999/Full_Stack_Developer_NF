                                        ...
                                        <div class="col-lg-6 me-auto ms-0 text-end">
                                          <div class="bg-gradient-primary border-radius-lg min-height-100">
                                            ...
                                            <div class="position-relative">
                                              <img class="max-width-500 w-100 position-relative z-index-2 rounded" src="./assets/img/landing1.png">
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6 me-auto ms-0 text-end">
                                            <div class="bg-gradient-primary border-radius-lg min-height-100">
                                              <img src="./assets/img/shapes/waves-white.svg" class="position-absolute h-100 top-0 d-md-block d-none" alt="waves">
                                              <div class="position-relative">
                                                <img class="max-width-500 w-100 position-relative z-index-2 rounded" src="./assets/img/landing2.png">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
